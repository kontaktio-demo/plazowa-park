    ...
    <section id="top" className="relative min-h-[100svh] w-full overflow-hidden bg-pine-deep">
      ...
      <div className="container-x relative flex min-h-[100svh] flex-col justify-end pb-16 pt-[var(--nav-h)]">
        <div className="max-w-2xl">
          ...
          <h1 className="hero-in mt-4 text-[clamp(2.4rem,6vw,5.4rem)] font-semibold leading-[1.06] text-paper" style={{ animationDelay: "0.18s" }}>
            Apartamenty nad<br />
            <span className="accent-serif text-[1.06em] text-brass-light">Zalewem Mrożyczka</span>
          </h1>
