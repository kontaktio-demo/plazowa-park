# Brief wykonawczy - landing page sprzedażowy inwestycji "Plażowa Park", Głowno

> Materiał źródłowy do złożenia w jeden brief wykonawczy. Ton: techniczny, bezpośredni. Wszystkie fakty zweryfikowane; rozbieżności oznaczone explicite.
